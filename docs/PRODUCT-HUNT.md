...
Wayfinder is a local desktop app for macOS and Windows that turns Codex and
Claude Code work into one visual voyage map. It records prompts, responses,
tool activity, file changes, branches, failures, and decisions while keeping
the complete history on your computer.
