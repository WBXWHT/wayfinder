...
| Claude Code CLI | Claude Plugin, or Core plus project Hooks | `wayfinder map` or MCP text result |
| Codex CLI | Codex Plugin, or Core plus project Hooks | `wayfinder map` or MCP text result |
