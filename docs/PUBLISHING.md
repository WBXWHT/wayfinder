...
Public release: **0.3.8 early access**. Product model updated 2026-09-11.
...
| Desktop app | https://github.com/WBXWHT/wayfinder/releases/tag/alpha-v0.3.8 | Apple Silicon and Intel DMGs plus Windows x64 NSIS installer |
