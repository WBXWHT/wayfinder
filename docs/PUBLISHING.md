...
Public release: **0.3.10 early access**. Product model updated 2026-09-11.
...
| Desktop app | https://github.com/StayCurious-Xuan/wayfinder/releases/tag/alpha-v0.3.10 | Apple Silicon and Intel DMGs plus Windows x64 NSIS installer |
